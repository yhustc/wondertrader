...
const TrdMarket TrdMarket_MAX = TrdMarket_SG;
...
const OrderType OrderType_MAX = OrderType_TrailingStopLimit;
...
const Currency Currency_MAX = Currency_SGD;
...
const SecurityFirm SecurityFirm_MAX = SecurityFirm_FutuSG;
...
const SimAccType SimAccType_MAX = SimAccType_Option;
