...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 7, 34, sizeof(::GetUserInfo::S2C)},
  { 56, 62, sizeof(::GetUserInfo::Request)},
  { 63, 72, sizeof(::GetUserInfo::Response)},
};
...
S2C::S2C(const S2C& from)
  ...
  ::memcpy(&hkqotright_, &from.hkqotright_,
    static_cast<size_t>(reinterpret_cast<char*>(&usotcqotright_) -
    reinterpret_cast<char*>(&hkqotright_)) + sizeof(usotcqotright_));
...
void S2C::SharedCtor() {
  ...
  ::memset(&hkqotright_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&usotcqotright_) -
      reinterpret_cast<char*>(&hkqotright_)) + sizeof(usotcqotright_));
}
...
// @@protoc_insertion_point(message_clear_start:GetUserInfo.S2C)
  ...
  if (cached_has_bits & 65280u) {
    ::memset(&cnqotright_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&subquota_) -
        reinterpret_cast<char*>(&cnqotright_)) + sizeof(subquota_));
  }
  if (cached_has_bits & 4128768u) {
    ::memset(&historyklquota_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&usotcqotright_) -
        reinterpret_cast<char*>(&historyklquota_)) + sizeof(usotcqotright_));
  }
  _has_bits_.Clear();
  _internal_metadata_.Clear();
}
