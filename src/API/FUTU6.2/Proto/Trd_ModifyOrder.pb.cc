...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 19, sizeof(::Trd_ModifyOrder::C2S)},
  { 33, 40, sizeof(::Trd_ModifyOrder::S2C)},
  { 42, 48, sizeof(::Trd_ModifyOrder::Request)},
  { 49, 58, sizeof(::Trd_ModifyOrder::Response)},
};
...
// @@protoc_insertion_point(message_clear_start:Trd_ModifyOrder.C2S)
  ...
  if (cached_has_bits & 252u) {
    ::memset(&orderid_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&forall_) -
        reinterpret_cast<char*>(&orderid_)) + sizeof(forall_));
  }
  if (cached_has_bits & 16128u) {
    ::memset(&adjustprice_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&trailspread_) -
        reinterpret_cast<char*>(&adjustprice_)) + sizeof(trailspread_));
  }
  _has_bits_.Clear();
