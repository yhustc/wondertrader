...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 14, sizeof(::Qot_Sub::C2S)},
  { 23, 28, sizeof(::Qot_Sub::S2C)},
  { 28, 34, sizeof(::Qot_Sub::Request)},
  { 35, 44, sizeof(::Qot_Sub::Response)},
};
...
C2S::C2S(const C2S& from)
  ...
  ::memcpy(&issuborunsub_, &from.issuborunsub_,
    ...
    reinterpret_cast<char*>(&issuborunsub_)) + sizeof(extendedtime_));
