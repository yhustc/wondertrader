...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 25, 40, sizeof(::Notify::QotRight)},
  { 50, 56, sizeof(::Notify::APILevel)},
  { 57, 64, sizeof(::Notify::APIQuota)},
  { 66, 78, sizeof(::Notify::S2C)},
  { 85, 94, sizeof(::Notify::Response)},
};
...
// @@protoc_insertion_point(message_clear_start:Notify.QotRight)
  ...
  if (cached_has_bits & 768u) {
    ::memset(&usindexqotright_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&usotcqotright_) -
        reinterpret_cast<char*>(&usindexqotright_)) + sizeof(usotcqotright_));
  }
  _has_bits_.Clear();
  _internal_metadata_.Clear();
}
